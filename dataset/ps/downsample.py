...
def random_sample(coords: np.ndarray, features: np.ndarray, semantic_labels: np.ndarray,
    ...
    return coords, features, semantic_labels, instance_labels
...
if __name__ == '__main__':
    ...
    for data_file in glob.glob(osp.join(data_dir, '*.pth')):
        # for data_file in glob.glob(osp.join(data_dir, "*.pth")):
        (coords, features, semantic_labels, instance_labels, room_label,
        ...
        if voxelize_flag:
            ...
            coords, features, semantic_labels, instance_labels = \
                random_sample(coords, features, semantic_labels, instance_labels, args.ratio)

        torch.save((coords, features, semantic_labels, instance_labels, room_label, scene), save_path)
